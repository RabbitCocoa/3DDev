...
class ShaderID
{
    ...
    public static readonly int _GlobalLightmap = Shader.PropertyToID("_GlobalLightmap");
    ...
    public static readonly int BounceCount = Shader.PropertyToID("BounceCount");
    ...
    public static readonly int _LightmapBakeMode = Shader.PropertyToID("_LightmapBakeMode");
